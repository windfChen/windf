CREATE TABLE `priority` (
  ...
  PRIMARY KEY (`id`),
  KEY `priority_fk_group_id` (`fk_group_id`) USING BTREE,
  CONSTRAINT `priority_fk_group_id` FOREIGN KEY (`fk_group_id`) REFERENCES `priority_group` (`id`)
...
CREATE TABLE `priority_group` (
  ...
  `fk_group_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_group_id` (`fk_group_id`) USING BTREE,
  CONSTRAINT `fk_group_id` FOREIGN KEY (`fk_group_id`) REFERENCES `priority_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
