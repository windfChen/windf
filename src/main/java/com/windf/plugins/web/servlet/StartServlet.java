...
public class StartServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		// 其他接口初始化
		new com.windf.module.sso.frame.Initialization().init();
		new com.windf.module.user.frame.Initialization().init();
		new com.windf.module.priority.frame.Initialization().init();
