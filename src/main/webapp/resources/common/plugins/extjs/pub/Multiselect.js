//version 3.0
//点击加搜索
function setSearchContent(V){
		if(Ext.get('searchContent')!=null && Ext.get('searchContent').dom!=null){
			var title =  Ext.get('searchContent').dom.value;
			title+=" "+ V +" ";
			Ext.get('searchContent').dom.value=title;
		}
}
...
Ext.ux.Multiselect = Ext.extend(Ext.form.Field,  {
	...
	onViewClick: function(vw, index, node, e) {
		...
		setSearchContent(this.store.getAt(index).get(this.displayField));
...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
	...
	hideNavIcons:false,
	imagePath:"",
	iconUp:resourceBasePath + "/common/plugins/extjs/images/up2.gif",
	iconDown:resourceBasePath + "/common/plugins/extjs/images/down2.gif",
	iconLeft:resourceBasePath + "/common/plugins/extjs/images/left2.gif",
	iconRight:resourceBasePath + "/common/plugins/extjs/images/right2.gif",
	iconTop:resourceBasePath + "/common/plugins/extjs/images/top2.gif",
	iconBottom:resourceBasePath + "/common/plugins/extjs/images/bottom2.gif",
	drawUpIcon:true,
	drawDownIcon:true,
	drawLeftIcon:true,
	drawRightIcon:true,
